      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-footer text-center">
            <button type="button" class="btn btn-success" onclick="cargarFiltroPaciente()">Filtrar</button>
          </div>
        </div>
        <!-- /.card -->
    ...
    <div class="modal-dialog modal-m" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="itemModalLabel">Agregar Paciente</h5>
...
<div class="modal fade" id="itemModal1" tabindex="-1" role="dialog" aria-labelledby="itemModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-m" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="itemModalLabel">Modificar Paciente</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="itemModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-m" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="itemModalLabel">Eliminar Paciente</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    function getPaciente(){
        $.ajax({
            url: "controlador/paciente.php?accion=lectura",
            type: "GET",
            success: function(val){
                ...
                for (i in val['paciente']) {
                    ...
                    aux = aux + '<td align="center">' + val['paciente'][i].nombre1 + " " + val['paciente'][i].nombre2 + '</td>';
                    aux = aux + '<td align="center">' + val['paciente'][i].apellido_paterno + " " + val['paciente'][i].apellido_materno + '</td>';
                    aux = aux + '<td align="center">' + val['paciente'][i].dni + '</td>';
                    aux = aux + '<td align="center">' + val['paciente'][i].fecha_nacimiento + '</td>';
                    aux = aux + '<td class="text-center" >';
                    aux = aux + '<button class="btn btn-info" type="button" onclick="cargarPaciente(\'' 
                    + val['paciente'][i].id + '\',\'' 
                    + val['paciente'][i].nombre1 + '\',\'' 
                    + val['paciente'][i].nombre2 + '\',\''
                    + val['paciente'][i].apellido_paterno + '\',\''  
                    + val['paciente'][i].apellido_materno + '\',\'' 
                    + val['paciente'][i].dni + '\',\'' 
                    + val['paciente'][i].fecha_nacimiento + '\''
                    + ')" data-toggle="modal" data-target="#itemModal1" title="modificar"><i class="fa fa-edit"></i></button>';
                    aux = aux + ' ';
                    aux = aux + '<button class="btn btn-danger" type="button" onclick="cargarEliminarPaciente(\''
                    + val['paciente'][i].id + '\',\''
                    + val['paciente'][i].nombre1 + ' ' + val['paciente'][i].nombre2 + ' ' + val['paciente'][i].apellido_paterno + " " + val['paciente'][i].apellido_materno +
    ...
    //seteo de modales
    function cargarPaciente(id, nombre1, nombre2, apellido_paterno, apellido_materno, dni, fecha_nacimiento) {
    ...
    function modificarPaciente(){
        ...
        $.ajax({
            ...
            url: "controlador/paciente.php?codigo=" + codigo + 
                                            '&nombre1=' + nombre1 + 
                                            '&nombre2=' + nombre2 + 
    ...
    function eliminarPaciente(){
        ...
        $.ajax({
            url: "controlador/paciente.php?codigo=" + codigo + "&nombre=" + nombre + '&accion=eliminar',
            type: "GET",
            success: function(val){
                var message;
                message = val['mensaje'].mensaje;
